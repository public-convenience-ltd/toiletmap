        ...
        <div className={layout.bandedSection}>
          <div className={layout.bandedSectionText}>
            <div className={layout.mainContainer}>
              ...
              <p>
                Domestos is proud to support the Great British Public Toilet
                Map.  Use Our Loos marks the latest step in Domestos’ mission is
                to win the war on poor sanitation. Worldwide, an estimated 2.5
                billion people lack access to proper sanitation while around 1
                billion don’t have sanitation facilities at all. Partnering with
                UNICEF, Domestos will help 25 million people around the world
                enjoy improved access to clean, safe, accessible toilets by
                2020. People in the UK can further support the mission by buying
                the Domestos bottle marked with the UNICEF logo.
              </p>
            </div>
          </div>
        </div>
