...
const UseOurLoosPage = (props) => {
  ...
  const mainFragment = (
    <div>
      ...
      <p>
        We're inviting businesses to sign up and welcome everyone, customers and
        non-customers, to use your loos. By joining our initiative, you will:
      </p>
      ...
      <p>
        Please note you must be a representative of any business you sign up to
        the scheme. Members of the public can help by encouraging their local
        ...
        <div className={layout.bandedSectionText}>
          <div className={layout.mainContainer}>
            ...
            <p>
              ...
              alike to access their toilet facilities during normal opening
              hours and display stickers to make people aware of their
            ...
            <p>
              ...
              throughout the UK have been steadily reduced. There is currently
              no legal requirement for local authorities to provide toilets.
              This often leads to loos being closed if councils deem they cannot
              afford the cost to maintain. This presents a struggle for the many
              individuals and families who have a greater need for access to
              public facilities; it’s also a basic human need for us all. The
              Use Our Loos scheme has been designed to bring the public loos
              back by opening more loos through cafes, restaurants, and shops,
              where facilities already exist.
            </p>
            <p>
              Community Toilet Schemes have been run successfully at a local
              level across the country but the public are often unaware of their
              existence. By bringing these schemes under one umbrella, as well
              as welcoming new members we hope to increase the value for
              everyone.
            </p>
            <h3>Does this scheme aim to replace traditional public toilets?</h3>
            <p>
              No. Purpose built public toilets serve an important role in public
              life, and we will continue to encourage councils to increase
              rather than cut provision. This scheme aims to find a
            ...
            <p>
              ...
              with a common and recognizable brand to enable the public to
              access them more easily. For areas where local schemes exist
              businesses are encouraged to sign up to both.
            </p>
