  ...
  const upsertLoos = async () => {
    ...
    for (const loo of allMongoLoos) {
      ...
      const mappedData = {
        ...
        baby_change: loo.properties.babyChange,
        men: loo.properties.men,
        no_payment: loo.properties.noPayment,
        notes: loo.properties.notes,
        payment_details: loo.properties.paymentDetails,
        radar: loo.properties.radar,
        removal_reason: loo.properties.removalReason,
        women: loo.properties.women,
        created_at: loo.createdAt,
        updated_at: loo.updatedAt,
        contributors: loo.contributors,
        urinal_only: loo.properties.urinalOnly,
        all_gender: loo.properties.allGender,
        children: loo.properties.children,
        opening_times: loo.properties.openingTimes ?? undefined,
        verified_at: loo.properties.verifiedAt,
