...
const ToiletMarkerIcon = L.DivIcon.extend({
  ...
  initialize: function (options) {
    this.options = {
      ...this.options,
      html: options.highlight
        ? `
        <div data-testid="toiletMarker:${options.toiletId}">
          <svg  viewBox="0 0 20 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M10 0C4.47632 0 0 4.47529 0 10C0 19.5501 10 32 10 32C10 32 20 19.5501 20 10C20 4.47529 15.5237 0 10 0Z" fill="#ED3D63"/>
